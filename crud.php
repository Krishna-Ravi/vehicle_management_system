...
if (isset($_GET['edit'])) {
  ...
  $rec = mysqli_query($con,"SELECT * FROM twowheeler WHERE vehicleid=$Vehicleid");
...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <tbody>
        <?php while($row = mysqli_fetch_array($results)){ ?>
          <tr>
            ...
            <td> <a class="del_btn" href="crudinsert.php?del=<?php echo $row['vehicleid']; ?>;">Delete</a> </td>
    ...
    <form action="crudinsert.php" method="post" enctype="multipart/form-data">
